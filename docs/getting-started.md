...
`Crdt` targets `netstandard2.0`, `netstandard2.1`, `net8.0`, `net9.0`, and `net10.0`. On .NET 8 and later it is annotated `IsAotCompatible` and is verified to run under NativeAOT.
